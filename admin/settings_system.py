...
from config import buttons, config
...
def get_settings_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        [build_btn('NOTIF_SETTINGS',  callback_data="settings:notifications")],
        [build_btn('ADMIN_ADMINS_MGR',  callback_data="settings:admins")],
        [build_btn('FORCE_CHANNELS',  callback_data="settings:channels")],
...
def get_notifications_keyboard(settings: dict) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        , style="primary")],
        [build_btn('SET_NOTIF_CHANNEL', 
            callback_data="settings:set_notification_chat"
        )],
        [build_btn('BACK',  callback_data="settings:back")]
    ])
